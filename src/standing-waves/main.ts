...
import { StandingWavesScreen } from "./StandingWavesScreen.js";
...
onReadyToLaunch(() => {
  ...
  const titleStringProperty = new StringProperty("Standing Waves");

  const screens = [
    new StandingWavesScreen({ tandem: Tandem.ROOT.createTandem("standingWavesScreen") }),
  ];
